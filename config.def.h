...
struct Config
{
     ...
     * medium ints             10
     */
    uint32_t tabmodkey :            14;
    uint32_t tabcyclekey :          14;
    ...
    unsigned int btborders :         1;
    unsigned int btbborders :        1;
    unsigned int bttag :             1;
    unsigned int btcentertxt :       1;
    unsigned int btsharegroupcol:    1;
...
void initcfg()
{
    ...
    cfg.iconspace       = 5;          /* space between icon and title */
    ...
    cfg.btborders       = 1;                /* 1 to show borders; 0 to disable          */
    cfg.btbborders      = 1;           /* 1 to show bottom border; 0 to disable    */
    cfg.bttag           = 1;          /* 1 to show tags in tabs; 0 to disable     */
    cfg.btcentertxt     = 1;         /* 1 to enable; 0 to disable                */
    cfg.bttagpx         = 5;                 /* # pixels for tag grid boxes              */
    cfg.bttagrow        = 3;                /* # rows in tag grid (9 tags, e.g. 3x3)    */
    cfg.btsharegroupcol = 0;        /* 1 same window type share same colour; 0 to disable  (recommended) */
