...
extern void ownergrabbutton(XEvent *event);
extern void buttonpress(XEvent *event);
extern void buttonrelease(XEvent *event);
extern void motionnotify(XEvent *event);
extern void pointermotion(XEvent *event);
extern void pointermotionhint(XEvent *event);
extern void button1motion(XEvent *event);
extern void button2motion(XEvent *event);
extern void button3motion(XEvent *event);
extern void button4motion(XEvent *event);
extern void button5motion(XEvent *event);
extern void buttonmotion(XEvent *event);
extern void enternotify(XEvent *event);
extern void enterwindow(XEvent *event);
extern void leavenotify(XEvent *event);
extern void leavewindow(XEvent *event);
...
extern void exposure(XEvent *event);
